...
description: Algoritmo e interfaz gráfica para resolver este juego
author: inazense
date: 2017-07-19 13:07:00 +0100
categories: [Java]
tags: [java, juegos]
image:
  path: /assets/pictures/posts/java_sudoku_logo.jpeg
  alt: Java post
---
...
Como curiosidad, sabed que el problema de un **sudoku** sólo se considera bien planteado si su solución es única, consiguiéndose esto sólo si, como mínimo, hay ya preestablecidas 17 cifras dentro del tablero ([Wikipedia intensifies](https://es.wikipedia.org/wiki/Sudoku)).

Dicho esto, vayamos a la resolución del problema.<br>
La idea que se me ocurrió, y que luego he ido leyendo que es la más sencilla de implementar, es la del **algoritmo de fuerza bruta** o como me gusta llamarlo a mi, el **algoritmo de marcha atrás**.
...
![Sudoku resuelto en Java](/assets/pictures/posts/java_sudoku_1.png)

![Sudoku no resuelto en Java](/assets/pictures/posts/java_sudoku_2.png)
