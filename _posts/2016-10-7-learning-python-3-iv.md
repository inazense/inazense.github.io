...
**21. Escriba un programa que muestre por pantalla todos los divisores de un número.**
...
**22. Escriba un programa que calcule el mínimo común múltiplo de dos números.**
...
**23. Escriba un programa que calcule el máximo común divisor de dos números**
...
**24. Escriba un programa que haga la descomposición en factores primos de un número.**
...
**25. Un número entero se dice perfecto si es igual a la suma de sus divisores (excepto él mismo, pero incluyendo el 1). El primer número perfecto es 6: 6=1+2+3. Escriba un programa que visualice los 4 primeros números perfectos.**
...
**26. Escriba un programa que calcule la raíz cuadrada de un número real positivo N**
