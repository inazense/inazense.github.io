...
![terminal progress basr]({{ site.baseurl }}/images/posts/terminal_progress_bar.png)
...
Hecho esto, veamos un par de ejemplos, harto sencillos ambos dos.<br>
...
Básicamente lo que estamos haciendo es importar nuestra **librería**, definir un valor hasta el que iterar y envolver el objeto sobre el que iteraremos con el método **tqdm**. Rápido y sencillo.<br>
