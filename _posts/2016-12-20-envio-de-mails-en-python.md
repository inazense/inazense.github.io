...
description: Crear un script para enviar emails en Python
author: inazense
date: 2016-12-20 10:53:00 +0100
categories: [Python]
tags: [python,script]
image:
...
![Python time strftime table](/assets/pictures/posts/python_datetime.png)
...
Lo primero es establecer la dirección de nuestro **servidor SMTP** para posteriormente usar. Después nos loguearemos usando el correo electrónico y la contraseña, y posteriormente usamos la función **sendmail** pasandole los parámetros de remitente, destinatario y el **email** a enviar, que establecimos anteriormente.<br>
...
![Python email](/assets/pictures/posts/python_email.png)
