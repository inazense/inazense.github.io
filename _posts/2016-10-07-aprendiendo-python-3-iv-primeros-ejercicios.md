...
description: Primeros problemas para familiarizarse con Python 3
author: inazense
date: 2016-10-07 17:35:00 +0100
categories: [Python]
tags: [python, problemas]
image:
...
```
 ...
 Escriba un programa que lea dos números desde teclado y si el primero es mayor que el segundo intercambie sus valores y los muestre ordenados por pantalla (después de haber intercambiado el valor de las variables correspondientes).
```python
# -*- coding: utf-8 -*-
...
```
 ...
 Escriba un programa que pregunte la edad al usuario, la fecha actual, y si ha cumplido años en el año actual o no, y en base a esa información calcule su año de nacimiento.
```python
# -*- coding: utf-8 -*-
...
Escriba un programa que pregunte la edad al usuario, la fecha actual, y en qué día y mes es su cumpleaños, y en base a esa información calcule su año de nacimiento.
```python
# -*- coding: utf-8 -*-
from datetime import datetime
...
Escriba un programa que calcule la cantidad total de segundos a partir de horas, minutos y segundos pedidos al usuario.
```python
# -*- coding: utf-8 -*-
...
Escriba un programa que haga lo contrario al ejercicio anterior.
```python
# -*- coding: utf-8 -*-
segundos = int(input('Segundos: '))
...
Escriba un programa que convierta euros en pesetas, y otro que convierta pesetas en euros.
```python
# -*- coding: utf-8 -*-
salida = False
...
Rehaga el ejercicio 3 con 3 números. (ordena tres números de menor a mayor)
```python
# -*- coding: utf-8 -*-
x = int(input('Primer número: '))
y = int(input('Segundo número: '))
...
Escriba un programa que calcule el equivalente en pies de una longitud en metros dada por el usuario, teniendo en cuenta que un metro equivale a 39,27 pulgadas y que 12 pulgadas equivalen a un pie.
```python
# -*- coding: utf-8 -*-
...
Escriba un programa que calcule si un año es bisiesto. Un año es bisiesto si es múltiplo de 4 pero no de 100 aunque sí de 400.
```python
# -*- coding: utf-8 -*-
...
Escriba un programa que lea por teclado 20 números reales y calcule su media. Hacerlo sin utilizar 20 variables reales.
```python
# -*- coding: utf-8 -*-
i = 20
r = 0
...
Escriba un programa que pida dos números enteros y nos muestre la tabla de multiplicar del primero hasta el número que indique el segundo.
```python
# -*- coding: utf-8 -*-
x = int(input('Primer número: '))
y = int(input('Segundo número: '))
...
Se definen los números triangulares como los obtenidos de sumar los números naturales sucesivos 1, 2, 3 … Es decir, los primeros números triangulares son 1, 3, 6, 10, etc. Escriba un programa que muestre los N primeros números triangulares.
```python
# -*- coding: utf-8 -*-
...
Escriba un programa que nos diga si un número es o no triangular, y cuál es el número triangular anterior y posterior al número.
```python
# -*- coding: utf-8 -*-
...
Elabore un programa que lea números enteros y escriba el número resultante de invertir sus cifras.
```python
# -*- coding: utf-8 -*-
x = int(input('Escribe un número: '))
...
Escriba un programa que detecte si un número es primo o no. Un número es primo si sólo es divisible por sí mismo y por la unidad.
```python
# -*- coding: utf-8 -*-
...
Escriba un programa que muestre por pantalla todos los divisores de un número.
```python
# -*- coding: utf-8 -*-
x = int(input('Escribe un número: '))
...
Escriba un programa que calcule el mínimo común múltiplo de dos números.
```python
# -*- coding: utf-8 -*-
...
Escriba un programa que calcule el máximo común divisor de dos números
```python
# -*- coding: utf-8 -*-
x = int(input('Escribe el primer número: '))
y = int(input('Escribe el segundo número: '))
...
Escriba un programa que haga la descomposición en factores primos de un número.
```python
# -*- coding: utf-8 -*-
from math import sqrt
...
Un número entero se dice perfecto si es igual a la suma de sus divisores (excepto él mismo, pero incluyendo el 1). El primer número perfecto es 6: 6=1+2+3. Escriba un programa que visualice los 4 primeros números perfectos.
```python
# -*- coding: utf-8 -*-
x = int(input('Escribe un número: '))
...
Escriba un programa que calcule la raíz cuadrada de un número real positivo N
```python
# -*- coding: utf-8 -*-
from math import sqrt
