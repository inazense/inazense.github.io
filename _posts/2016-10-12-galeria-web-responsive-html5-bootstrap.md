...
image:
  path: /assets/pictures/posts/javascript_logo.jpg
  alt: Javascript post
---
...
Los requisitos que buscaba es que fuera responsive y que su carga fuese rápida. No quería perder mucho tiempo desarrollando una galería con esas características desde cero y me puse a buscar hasta que llegué a [este proyecto en Github de Dmitry Semenov](https://github.com/dimsemenov/Magnific-Popup).
...
El código completo del ejemplo puedes bajartelo desde [mi repositorio de Github](https://github.com/inazense/gallery-responsive).
